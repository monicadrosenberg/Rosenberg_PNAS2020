function [r, p, pos_overlap, neg_overlap, predicted_behav] = predict_session_performance(fc_mats, behav, p_thresh)
...
% 19(1), 165-171. Coefficients were defined using robustfit in Matlab.
% 
% INPUT
